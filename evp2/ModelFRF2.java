...
public class ModelFRF2 extends ModelGun {
    ...
    public ModelFRF2() {
        ...
        super.gunModel[0].addObj("/Modern Weapons Pack/assets/flansmod/models/FRF2_body.obj");
        super.gunModel[0].setRotationPoint(3.5F, 2.0F, 0.0F);
        super.ammoModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        super.ammoModel[0].addObj("/Modern Weapons Pack/assets/flansmod/models/FRF2_magazine.obj");
        super.ammoModel[0].setRotationPoint(3.5F, 2.0F, 0.0F);
        super.pumpModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        super.pumpModel[0].addObj("/Modern Weapons Pack/assets/flansmod/models/FRF2_cock.obj");
