...
public class ModelMakarov extends ModelGun {
    ...
    public ModelMakarov() {
        ...
        super.gunModel[0].addBox(-1.0F, -1.0F, -1.0F, 2, 3, 2);
        super.gunModel[1] = new ModelRendererTurbo(this, 0, 5, textureX, textureY);
        super.gunModel[1].addShapeBox(-2.0F, 2.0F, -1.0F, 5, 1, 2, 0.0F, -1.0F, 0.0F, 0.0F, -2.0F, 0.0F, 0.0F, -2.0F,
        ...
        super.gunModel[2].addBox(0.5F, 3.0F, -0.5F, 6, 1, 1);
        super.slideModel = new ModelRendererTurbo[3];
        super.slideModel[0] = new ModelRendererTurbo(this, 0, 10, textureX, textureY);
        super.slideModel[0].addShapeBox(-2.0F, 3.0F, -1.0F, 8, 2, 2, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
                0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -1.0F, 0.0F, 0.0F);
        super.slideModel[1] = new ModelRendererTurbo(this, 2, 5, textureX, textureY);
        super.slideModel[1].addBox(-0.5F, 4.25F, -0.5F, 1, 1, 1);
        super.slideModel[2] = new ModelRendererTurbo(this, 2, 5, textureX, textureY);
        super.slideModel[2].addBox(4.75F, 4.25F, -0.5F, 1, 1, 1);
        super.ammoModel = new ModelRendererTurbo[1];
        super.ammoModel[0] = new ModelRendererTurbo(this, 13, 0, textureX, textureY);
        super.ammoModel[0].addBox(-0.9F, -0.75F, -0.5F, 1.8F, 4.0F, 1.0F);
