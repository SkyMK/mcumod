...
public class ModelSkyshield extends ModelAAGun {
    ...
    public ModelSkyshield() {
        this.textureX = 512;
        this.textureY = 512;
        (this.baseModel = new ModelRendererTurbo[6])[0] = new ModelRendererTurbo(this, 0, 500,
        ...
        (this.seatModel = new ModelRendererTurbo[18])[0] = new ModelRendererTurbo(this, 0, 400,
                this.textureX, this.textureY);
        ...
        this.seatModel[16].addShape3D(0.0f, 0.0f, 0.0f,
                new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(38.0, 0.0, 38, 0),
                        new Coord2D(38.0, 6.0, 38, 6), new Coord2D(36.0, 8.0, 36, 8), new Coord2D(16.0, 8.0, 16, 8)}),
                14.0f, 38, 8, 85, 14, 0, new float[]{18.0f, 20.0f, 3.0f, 6.0f, 38.0f});
        this.seatModel[16].setRotationPoint(18.0f, -20.0f, 18.0f);
        this.seatModel[17].addShape3D(0.0f, 0.0f, 0.0f,
                new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(38.0, 0.0, 38, 0),
                        new Coord2D(38.0, 6.0, 38, 6), new Coord2D(36.0, 8.0, 36, 8), new Coord2D(16.0, 8.0, 16, 8)}),
                14.0f, 38, 8, 85, 14, 0, new float[]{18.0f, 20.0f, 3.0f, 6.0f, 38.0f});
        this.seatModel[17].setRotationPoint(18.0f, -20.0f, -4.0f);
        (this.gunModel = new ModelRendererTurbo[3])[0] = new ModelRendererTurbo(this, 0, 370, this.textureX,
                this.textureY);
