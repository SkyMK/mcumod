...
public class ModelIZH43 extends ModelGun {
    int textureX;
    int textureY;
    ...
    public ModelIZH43() {
        this.textureX = 64;
        this.textureY = 32;
        (this.gunModel = new ModelRendererTurbo[17])[0] = new ModelRendererTurbo(this, 0, 0, this.textureX,
                this.textureY);
        ...
        this.gunModel[3].addBox(0.0f, 0.0f, 0.0f, 15, 1, 1, 0.0f);
        ...
        this.gunModel[4].rotateAngleZ = 0.418879f;
        ...
        this.gunModel[10].addBox(0.0f, 0.0f, 0.0f, 15, 1, 1, 0.0f);
        ...
        this.gunModel[13].addBox(0.0f, 0.0f, 0.0f, 6, 1, 1, 0.0f);
        this.gunModel[13].setRotationPoint(-7.0f, 0.6f, -0.5f);
        this.gunModel[13].rotateAngleZ = 0.1919862f;
        this.gunModel[14].addBox(0.0f, 0.0f, 0.0f, 3, 3, 1, 0.0f);
        this.gunModel[14].setRotationPoint(-7.0f, -2.0f, -0.5f);
        this.gunModel[15].addBox(0.0f, 0.0f, 0.0f, 5, 2, 1, 0.0f);
        this.gunModel[15].setRotationPoint(-6.0f, -2.0f, -0.5f);
        this.gunModel[16].addBox(0.0f, 0.0f, 0.0f, 1, 1, 1, 0.0f);
        this.gunModel[16].setRotationPoint(-1.0f, -2.0f, -0.5f);
        this.gunModel[16].rotateAngleZ = -0.7853982f;
