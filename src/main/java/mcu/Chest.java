...
public class Chest extends ItemArmor implements IArmorModel {
    public String icon;
    ...
    public Chest(int n, ItemArmor.ArmorMaterial anxb2, String string, final String string2, final String texture, EWjURWOUrw model) {
        super(anxb2, 1, 1);
        ...
        if (FMLCommonHandler.instance().getEffectiveSide().isClient()) {
            ...
            DayZHud.textures.add("mcuniversal:obj/" + texture + ".png");
        }
    }
