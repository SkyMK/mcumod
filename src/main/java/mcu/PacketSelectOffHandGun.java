...
public class PacketSelectOffHandGun extends PacketBase {
    ...
    public void handleServerSide(EntityPlayerMP playerEntity) {
        ...
        FlansMod.getPacketHandler().sendToAllAround(new PacketOffHandGunInfo(playerEntity, this.slot),
                playerEntity.posX, playerEntity.posY, playerEntity.posZ, 50.0F, playerEntity.dimension);
    }
