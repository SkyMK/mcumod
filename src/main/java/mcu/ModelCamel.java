...
public class ModelCamel extends ModelPlane {
    ...
    public ModelCamel() {
        ...
        super.propellerModels[0][0].addBox(0.0F, -7.0F, -1.0F, 2, 5, 2, 0.0F);
        super.propellerModels[0][1].addBox(0.0F, -7.0F, -1.0F, 2, 5, 2, 0.0F);
        super.propellerModels[0][2].addBox(0.0F, -7.0F, -1.0F, 2, 5, 2, 0.0F);
        super.propellerModels[0][0].setRotationPoint(-27.0F, 0.0F, 0.0F);
        super.propellerModels[0][1].setRotationPoint(-27.0F, 0.0F, 0.0F);
        super.propellerModels[0][2].setRotationPoint(-27.0F, 0.0F, 0.0F);
        ...
        super.yawFlapModel[0].setPosition(40.0F, -12.0F, -1.0F);
        ...
        super.pitchFlapLeftModel[0].setPosition(40.0F, 3.0F, -15.0F);
        ...
        super.pitchFlapRightModel[0].setPosition(40.0F, 3.0F, 0.0F);
        ...
        super.noseModel = new ModelRendererTurbo[4];
        super.noseModel[0] = new ModelRendererTurbo(this, 44, 0, textureX, textureY);
        super.noseModel[1] = new ModelRendererTurbo(this, 0, 64, textureX, textureY);
        super.noseModel[2] = new ModelRendererTurbo(this, 12, 32, textureX, textureY);
        super.noseModel[3] = new ModelRendererTurbo(this, 12, 32, textureX, textureY);
        super.noseModel[0].addBox(0.0F, 0.0F, 0.0F, 4, 4, 4, 0.0F);
        super.noseModel[0].setPosition(-28.0F, -2.0F, -2.0F);
        super.noseModel[1].addBox(0.0F, 0.0F, 0.0F, 12, 10, 18, 0.0F);
        super.noseModel[1].setPosition(-24.0F, -3.0F, -9.0F);
        super.noseModel[2].addBox(-24.0F, -5.0F, 2.0F, 14, 2, 2, 0.0F);
        super.noseModel[3].addBox(-24.0F, -5.0F, -4.0F, 14, 2, 2, 0.0F);
        ...
        super.tailModel[0].addBox(11.0F, -2.0F, -5.0F, 40, 8, 10, 0.0F);
