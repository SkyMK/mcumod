        ...
        if (stack.stackTagCompound == null) {
            ...
            if (stack.stackTagCompound == null) {
                ...
                stack.stackTagCompound.setString("Engine",
                        ((PartType) PartType.defaultEngines.get(EnumType.plane)).shortName);
            }
        }
        ...
        try {
            ...
            if (e != null && e.exists()) {
                ...
                for (int var8 = 0; var8 < var7; ++var8) {
                    ...
                    tags.setInteger(part.getShortName() + "_Health", this.type.health.get(part) == null ? 0
                            : ((CollisionBox) this.type.health.get(part)).health);
            ...
            if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
                ...
                if (this.type.placeableOnLand || block instanceof BlockLiquid) {
                    if (!world.isRemote) {
                        ...
                        if (data != null) {
                            world.spawnEntityInWorld(new EntityPlane(world, (double) i + 0.5D, (double) j + 2.5D,
                                    (double) k + 0.5D, entityplayer, this.type, data));
                        }
                    }
