...
public class ModelSpitfire extends ModelPlane {
    ...
    public ModelSpitfire() {
        ...
        super.bodyModel[0].addBox(-3.0F, 0.0F, -31.0F, 20, 2, 20);
        super.bodyModel[0].setPosition(0.0F, 5.0F, 21.0F);
        super.bodyModel[1].addBox(-3.0F, -16.0F, -10.0F, 20, 16, 2);
        super.bodyModel[1].setPosition(0.0F, 5.0F, 0.0F);
        ...
        super.noseModel[1].setPosition(-55.0F, 0.0F, -2.0F);
        super.tailModel = new ModelRendererTurbo[1];
        super.tailModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY);
        super.tailModel[0].addTrapezoid(17.0F, -16.0F, -10.0F, 76, 18, 20, 0.0F, -3.0F, 2);
        super.tailModel[0].setPosition(0.0F, 5.0F, 0.0F);
        ...
        super.rightWingModel = new ModelRendererTurbo[3];
        ...
        super.rightWingModel[2] = new ModelRendererTurbo(this, 192, 25, textureX, textureY);
        super.rightWingModel[0].addBox(-25.0F, -2.0F, 0.0F, 32, 2, 78, 0.0F);
        super.rightWingModel[0].setPosition(0.0F, 5.0F, 0.0F);
        super.rightWingModel[1].addTrapezoid(-25.0F, 3.0F, 78.0F, 32, 2, 10, 0.0F, -1.0F, 1);
        super.rightWingModel[2].addBox(-37.0F, 3.0F, 43.0F, 12, 2, 2, 0.0F);
        super.leftWingModel = new ModelRendererTurbo[3];
        ...
        super.leftWingModel[2] = new ModelRendererTurbo(this, 192, 25, textureX, textureY);
        ...
        super.leftWingModel[2].addBox(-37.0F, 3.0F, -45.0F, 12, 2, 2, 0.0F);
        ...
        super.propellerModels[0][0].setRotationPoint(-54.0F, 0.0F, 0.0F);
        super.propellerModels[0][1].setRotationPoint(-54.0F, 0.0F, 0.0F);
        super.propellerModels[0][2].setRotationPoint(-54.0F, 0.0F, 0.0F);
