...
public class ModelAKM extends ModelGun {
    ...
    public ModelAKM() {
        ...
        (this.ammoModel = new ModelRendererTurbo[3])[0] = new ModelRendererTurbo(this, 0, 20, this.textureX,
                this.textureY);
        this.ammoModel[1] = new ModelRendererTurbo(this, 0, 20, this.textureX, this.textureY);
        this.ammoModel[2] = new ModelRendererTurbo(this, 0, 20, this.textureX, this.textureY);
        ...
        this.ammoModel[1].setRotationPoint(3.0f, -1.0f, -0.5f);
        this.ammoModel[1].rotateAngleZ = 0.3141593f;
        this.ammoModel[2].addBox(0.0f, 0.0f, 0.0f, 2, 2, 1, 0.0f);
        this.ammoModel[2].setRotationPoint(3.6f, 0.9f, -0.5f);
        this.ammoModel[2].rotateAngleZ = 0.7679449f;
        this.barrelAttachPoint = new Vector3f(1.0625f, 0.15625f, 0.0f);
        this.stockAttachPoint = new Vector3f(0.04375f, 0.1875f, 0.0f);
