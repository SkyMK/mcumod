...
public class ModelM4A1 extends ModelGun {
    ...
    public ModelM4A1() {
        ...
        this.gunModel[19].rotateAngleZ = 0.01745329f;
        this.gunModel[20].addBox(0.0f, 0.0f, -1.0f, 5, 1, 1, 0.0f);
        this.gunModel[20].setRotationPoint(5.5f, -4.3f, 1.0f);
        this.gunModel[20].rotateAngleY = -0.01745329f;
        ...
        this.defaultStockModel[9] = new ModelRendererTurbo(this, 25, 4, this.textureX, this.textureY);
        this.defaultStockModel[10] = new ModelRendererTurbo(this, 25, 3, this.textureX, this.textureY);
        ...
        this.defaultStockModel[8].addBox(0.0f, 0.0f, 0.0f, 1, 4, 1, 0.0f);
        this.defaultStockModel[8].setRotationPoint(-6.0f, -4.6f, -0.5f);
        this.defaultStockModel[9].addBox(-1.0f, -3.0f, 0.0f, 1, 3, 1, 0.0f);
        this.defaultStockModel[9].setRotationPoint(-5.0f, -0.6f, -0.5f);
        this.defaultStockModel[9].rotateAngleZ = -0.7853982f;
        this.defaultStockModel[10].addBox(0.3f, -1.0f, 0.0f, 1, 2, 1, 0.0f);
        this.defaultStockModel[10].setRotationPoint(-3.5f, -3.0f, -0.5f);
