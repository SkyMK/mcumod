...
public class ModelRemington700 extends ModelGun {
    int textureX;
    int textureY;

    public ModelRemington700() {
        this.textureX = 64;
        this.textureY = 128;
        (this.gunModel = new ModelRendererTurbo[22])[0] = new ModelRendererTurbo(this, 0, 0, this.textureX,
                this.textureY);
        ...
        this.gunModel[3].addBox(0.0f, 0.0f, 0.0f, 22, 1, 1, 0.0f);
        this.gunModel[3].setRotationPoint(2.8f, -4.0f, -0.5f);
        ...
        this.gunModel[10].rotateAngleZ = -0.0872665f;
        ...
        this.gunModel[14].rotateAngleZ = 0.191986f;
        ...
        this.gunModel[16].setRotationPoint(-7.0f, -1.4f, -0.5f);
        this.gunModel[17].addBox(0.0f, 0.0f, 0.0f, 1, 1, 1, 0.0f);
        this.gunModel[17].setRotationPoint(-7.0f, -0.5f, -0.5f);
        ...
        (this.ammoModel[0] = new ModelRendererTurbo(this, 0, 7, this.textureX, this.textureY)).addBox(0.0f,
