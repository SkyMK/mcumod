...
public class Leggins extends ItemArmor implements IArmorModel {
    public String icon;
    ...
    public Leggins(final int n, final ItemArmor.ArmorMaterial anxb2, final String string, final String string2,
