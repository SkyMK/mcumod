...
public class ModelBwTruck extends ModelVehicle {
    ...
    public ModelBwTruck() {
        this.textureX = 512;
        this.textureY = 512;
        (this.bodyModel = new ModelRendererTurbo[97])[0] = new ModelRendererTurbo(this, 410, 450,
        ...
        this.bodyModel[22].addShape3D(0.0f, 0.0f, 0.0f,
                ...
                6.0f, 16, 16, 56, 6, 0, new float[]{8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f});
        ...
        this.bodyModel[94].addShape3D(0.0f, 0.0f, 0.0f,
                new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(5.0, 0.0, 5, 0),
                        new Coord2D(11.0, 15.0, 11, 15), new Coord2D(11.0, 17.0, 11, 17), new Coord2D(8.0, 17.0, 8, 17),
                        new Coord2D(5.0, 14.0, 5, 14)}),
                1.0f, 11, 17, 47, 1, 0, new float[]{15.0f, 5.0f, 3.0f, 2.0f, 17.0f, 5.0f});
        ...
        this.bodyModel[96].addShape3D(0.0f, 0.0f, 0.0f,
                new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(6.0, 1.0, 6, 1),
                        new Coord2D(6.0, 3.0, 6, 3), new Coord2D(3.0, 3.0, 3, 3)}),
                34.0f, 6, 3, 17, 34, 0, new float[]{5.0f, 3.0f, 2.0f, 7.0f});
        this.bodyModel[96].setRotationPoint(40.0f, -36.0f, 17.0f);
        (this.leftFrontWheelModel = new ModelRendererTurbo[1])[0] = new ModelRendererTurbo(this, 0, 490,
                this.textureX, this.textureY);
        this.leftFrontWheelModel[0].addShape3D(8.0f, -8.0f, -3.0f,
                new Shape2D(new Coord2D[]{new Coord2D(5.0, 0.0, 5, 0), new Coord2D(11.0, 0.0, 11, 0),
                        new Coord2D(16.0, 5.0, 16, 5), new Coord2D(16.0, 11.0, 16, 11), new Coord2D(11.0, 16.0, 11, 16),
                        new Coord2D(5.0, 16.0, 5, 16), new Coord2D(0.0, 11.0, 0, 11), new Coord2D(0.0, 5.0, 0, 5)}),
                6.0f, 16, 16, 56, 6, 0, new float[]{8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f});
        this.leftFrontWheelModel[0].setRotationPoint(20.0f, 2.0f, 17.0f);
        (this.rightFrontWheelModel = new ModelRendererTurbo[1])[0] = new ModelRendererTurbo(this, 0, 490,
                this.textureX, this.textureY);
        this.rightFrontWheelModel[0].addShape3D(8.0f, -8.0f, -3.0f,
                new Shape2D(new Coord2D[]{new Coord2D(5.0, 0.0, 5, 0), new Coord2D(11.0, 0.0, 11, 0),
                        new Coord2D(16.0, 5.0, 16, 5), new Coord2D(16.0, 11.0, 16, 11), new Coord2D(11.0, 16.0, 11, 16),
                        new Coord2D(5.0, 16.0, 5, 16), new Coord2D(0.0, 11.0, 0, 11), new Coord2D(0.0, 5.0, 0, 5)}),
                6.0f, 16, 16, 56, 6, 0, new float[]{8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f});
        this.rightFrontWheelModel[0].setRotationPoint(20.0f, 2.0f, -17.0f);
        (this.leftBackWheelModel = new ModelRendererTurbo[1])[0] = new ModelRendererTurbo(this, 0, 490,
                this.textureX, this.textureY);
        this.leftBackWheelModel[0].addShape3D(8.0f, -8.0f, -3.0f,
                new Shape2D(new Coord2D[]{new Coord2D(5.0, 0.0, 5, 0), new Coord2D(11.0, 0.0, 11, 0),
                        new Coord2D(16.0, 5.0, 16, 5), new Coord2D(16.0, 11.0, 16, 11), new Coord2D(11.0, 16.0, 11, 16),
                        new Coord2D(5.0, 16.0, 5, 16), new Coord2D(0.0, 11.0, 0, 11), new Coord2D(0.0, 5.0, 0, 5)}),
                6.0f, 16, 16, 56, 6, 0, new float[]{8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f});
        this.leftBackWheelModel[0].setRotationPoint(-31.0f, 2.0f, 17.0f);
        (this.rightBackWheelModel = new ModelRendererTurbo[1])[0] = new ModelRendererTurbo(this, 0, 490,
                this.textureX, this.textureY);
        this.rightBackWheelModel[0].addShape3D(8.0f, -8.0f, -3.0f,
                new Shape2D(new Coord2D[]{new Coord2D(5.0, 0.0, 5, 0), new Coord2D(11.0, 0.0, 11, 0),
                        new Coord2D(16.0, 5.0, 16, 5), new Coord2D(16.0, 11.0, 16, 11), new Coord2D(11.0, 16.0, 11, 16),
                        new Coord2D(5.0, 16.0, 5, 16), new Coord2D(0.0, 11.0, 0, 11), new Coord2D(0.0, 5.0, 0, 5)}),
                6.0f, 16, 16, 56, 6, 0, new float[]{8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f, 8.0f, 6.0f});
