...
public class ModelMIG15 extends ModelPlane {
    ...
    public ModelMIG15() {
        ...
        (this.noseModel[0] = new ModelRendererTurbo(this, 0, 450, this.textureX, this.textureY))
                .addTrapezoid(0.0f, 0.0f, 0.0f, 22, 22, 22, 0.0f, -4.0f, 3);
        this.noseModel[0].setRotationPoint(-36.0f, -21.0f, -11.0f);
        (this.bodyModel = new ModelRendererTurbo[13])[0] = new ModelRendererTurbo(this, 95, 450,
        ...
        (this.tailModel = new ModelRendererTurbo[6])[0] = new ModelRendererTurbo(this, 0, 370,
                this.textureX, this.textureY);
        ...
        this.tailModel[3].addShape3D(0.0f, 0.0f, 0.0f,
                new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(46.0, 0.0, 46, 0),
                        new Coord2D(52.0, 4.0, 52, 4), new Coord2D(75.0, 30.0, 75, 30), new Coord2D(75.0, 32.0, 75, 32),
                        new Coord2D(72.0, 34.0, 72, 34), new Coord2D(62.0, 35.0, 62, 35),
                        new Coord2D(56.0, 32.0, 56, 32)}),
                2.0f, 75, 35, 178, 2, 0, new float[]{65.0f, 7.0f, 11.0f, 4.0f, 2.0f, 35.0f, 8.0f, 46.0f});
        ...
        this.tailModel[4].addShape3D(0.0f, 0.0f, 0.0f,
                new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(22.0, 0.0, 22, 0),
                        new Coord2D(32.0, 21.0, 32, 21), new Coord2D(28.0, 24.0, 28, 24),
                        new Coord2D(24.0, 25.0, 24, 25)}),
                1.0f, 32, 25, 91, 1, 0, new float[]{35.0f, 5.0f, 5.0f, 24.0f, 22.0f});
        ...
        (this.rightWingModel = new ModelRendererTurbo[2])[0] = new ModelRendererTurbo(this, 115, 400,
                this.textureX, this.textureY);
        ...
        this.rightWingModel[1].addShape3D(0.0f, 0.0f, 0.0f,
                new Shape2D(new Coord2D[]{new Coord2D(0.0, 0.0, 0, 0), new Coord2D(40.0, 0.0, 40, 0),
                        new Coord2D(40.0, 8.0, 40, 8), new Coord2D(74.0, 64.0, 74, 64), new Coord2D(68.0, 68.0, 68, 68),
                        new Coord2D(52.0, 69.0, 52, 69), new Coord2D(44.0, 64.0, 44, 64)}),
                2.0f, 74, 69, 227, 2, 0, new float[]{78.0f, 10.0f, 17.0f, 8.0f, 66.0f, 8.0f, 40.0f});
        ...
        (this.leftWingModel = new ModelRendererTurbo[2])[0] = new ModelRendererTurbo(this, 115, 410,
                this.textureX, this.textureY);
        ...
        (this.bodyWheelModel = new ModelRendererTurbo[4])[0] = new ModelRendererTurbo(this, 0, 340,
                this.textureX, this.textureY);
        ...
        (this.leftWingWheelModel = new ModelRendererTurbo[5])[0] = new ModelRendererTurbo(this, 135, 340,
                this.textureX, this.textureY);
        ...
        (this.rightWingWheelModel = new ModelRendererTurbo[5])[0] = new ModelRendererTurbo(this, 70, 340,
                this.textureX, this.textureY);
    ...
    private ModelRendererTurbo[] makeProp1(final int i, final int j, final int k) {
        final ModelRendererTurbo[] prop = {
                new ModelRendererTurbo(this, 0, 0, this.textureX, this.textureY),
                new ModelRendererTurbo(this, 0, 0, this.textureX, this.textureY),
                new ModelRendererTurbo(this, 0, 0, this.textureX, this.textureY)};
