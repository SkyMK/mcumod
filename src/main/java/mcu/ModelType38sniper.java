...
public class ModelType38sniper extends ModelGun {
    ...
    public ModelType38sniper() {
        ...
        super.gunModel[15] = new ModelRendererTurbo(this, 0, 112, this.textureX, this.textureY);
        super.gunModel[16] = new ModelRendererTurbo(this, 0, 50, this.textureX, this.textureY);
        super.gunModel[17] = new ModelRendererTurbo(this, 0, 50, this.textureX, this.textureY);
        super.gunModel[18] = new ModelRendererTurbo(this, 0, 50, this.textureX, this.textureY);
        super.gunModel[19] = new ModelRendererTurbo(this, 0, 50, this.textureX, this.textureY);
        ...
        super.gunModel[15].addBox(0.0F, 0.0F, 0.0F, 6, 1, 1, 0.0F);
        super.gunModel[15].setRotationPoint(4.0F, -4.5F, -0.5F);
        super.gunModel[16].addBox(0.0F, 0.0F, 0.0F, 8, 1, 1, 0.0F);
        super.gunModel[16].setRotationPoint(3.0F, -5.3F, -0.3F);
        super.gunModel[17].addBox(0.0F, 0.0F, -0.7F, 8, 1, 1, 0.0F);
        super.gunModel[17].setRotationPoint(3.0F, -5.3F, 0.0F);
        super.gunModel[18].addBox(0.0F, 0.0F, -0.3F, 8, 1, 1, 0.0F);
        super.gunModel[18].setRotationPoint(3.0F, -5.6F, 0.0F);
        super.gunModel[19].addBox(0.0F, 0.0F, -0.7F, 8, 1, 1, 0.0F);
        super.gunModel[19].setRotationPoint(3.0F, -5.6F, 0.0F);
        ...
        super.pumpModel[0] = new ModelRendererTurbo(this, 30, 130, this.textureX, this.textureY);
        super.pumpModel[0].addBox(0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F);
        super.pumpModel[0].setRotationPoint(3.0F, -3.7F, -1.5F);
