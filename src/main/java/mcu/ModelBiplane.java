...
public class ModelBiplane extends ModelPlane {
    ...
    public ModelBiplane() {
        ...
        super.pitchFlapLeftModel[0].rotateAngleX = 1.5707964F;
        ...
        super.pitchFlapRightModel[0].rotateAngleX = 1.5707964F;
        ...
        super.bodyModel[0].rotateAngleX = 1.5707964F;
        super.bodyModel[1].rotateAngleY = 4.712389F;
        super.bodyModel[2].rotateAngleY = 1.5707964F;
        ...
        super.rightWingModel[2] = new ModelRendererTurbo(this, 56, 15, textureX, textureY);
        super.rightWingModel[3] = new ModelRendererTurbo(this, 56, 15, textureX, textureY);
        ...
        super.rightWingModel[1].addBox(-7.0F, -18.0F, -40.0F, 2, 18, 2, 0.0F);
        super.rightWingModel[2].addBox(5.0F, -18.0F, -40.0F, 2, 18, 2, 0.0F);
        super.rightWingModel[3].addBox(-7.0F, -18.0F, -16.0F, 2, 18, 2, 0.0F);
        super.rightWingModel[4].addBox(5.0F, -18.0F, -16.0F, 2, 18, 2, 0.0F);
        ...
        super.leftWingModel[2] = new ModelRendererTurbo(this, 56, 15, textureX, textureY);
        super.leftWingModel[3] = new ModelRendererTurbo(this, 56, 15, textureX, textureY);
        ...
        super.leftWingModel[1].addBox(-7.0F, -18.0F, 38.0F, 2, 18, 2, 0.0F);
        super.leftWingModel[2].addBox(5.0F, -18.0F, 38.0F, 2, 18, 2, 0.0F);
        super.leftWingModel[3].addBox(-7.0F, -18.0F, 14.0F, 2, 18, 2, 0.0F);
        super.leftWingModel[4].addBox(5.0F, -18.0F, 14.0F, 2, 18, 2, 0.0F);
