...
public class ModelRemington870 extends ModelGun {
    int textureX;
    int textureY;
    ...
    public ModelRemington870() {
        ...
        this.gunModel[5].setRotationPoint(2.3f, -2.4f, -0.5f);
        ...
        this.gunModel[17].setRotationPoint(18.3f, -4.0f, 0.0f);
        ...
        this.gunModel[20].setRotationPoint(-6.0f, -1.0f, -0.5f);
        ...
        this.barrelAttachPoint = new Vector3f(1.125f, 0.19375f, 0.0f);
