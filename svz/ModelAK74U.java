...
public class ModelAK74U extends ModelGun {
    int textureX;
    int textureY;
    ...
    public ModelAK74U() {
        this.textureX = 64;
        this.textureY = 128;
        (this.gunModel = new ModelRendererTurbo[23])[0] = new ModelRendererTurbo(this, 0, 3, this.textureX,
                this.textureY);
        ...
        this.gunModel[18].addBox(0.0f, 0.0f, 0.0f, 2, 2, 1, 0.0f);
        this.gunModel[18].setRotationPoint(9.0f, -4.0f, -0.7f);
        this.gunModel[19].addBox(0.0f, 0.0f, 0.0f, 2, 2, 1, 0.0f);
        this.gunModel[19].setRotationPoint(9.0f, -4.0f, -0.2f);
        this.gunModel[20].addBox(0.0f, 0.0f, 0.0f, 3, 1, 1, 0.0f);
        this.gunModel[20].setRotationPoint(11.0f, -3.0f, -0.5f);
        this.gunModel[21].addBox(0.0f, 0.0f, 0.0f, 1, 2, 1, 0.0f);
        this.gunModel[21].setRotationPoint(11.0f, -4.5f, -0.5f);
        this.gunModel[21].rotateAngleZ = -0.06981317f;
        this.gunModel[22].addBox(0.0f, 0.0f, 0.0f, 1, 1, 1, 0.0f);
        this.gunModel[22].setRotationPoint(2.0f, -2.4f, -0.5f);
        (this.defaultStockModel = new ModelRendererTurbo[2])[0] = new ModelRendererTurbo(this, 26, 0,
                this.textureX, this.textureY);
        this.defaultStockModel[1] = new ModelRendererTurbo(this, 20, 0, this.textureX, this.textureY);
        this.defaultStockModel[0].addBox(0.0f, 0.0f, 0.0f, 6, 1, 1, 0.0f);
        this.defaultStockModel[0].setRotationPoint(-6.0f, -3.1f, -0.5f);
        this.defaultStockModel[1].addBox(0.0f, 0.0f, 0.0f, 1, 3, 1, 0.0f);
        this.defaultStockModel[1].setRotationPoint(-6.0f, -3.56f, -0.5f);
        ...
        this.barrelAttachPoint = new Vector3f(0.8125f, 0.15625f, 0.0f);
