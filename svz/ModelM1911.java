...
public class ModelM1911 extends ModelGun {
    ...
    public ModelM1911() {
        ...
        this.gunModel[12] = new ModelRendererTurbo(this, 5, 0, this.textureX, this.textureY);
        ...
        this.gunModel[1].setRotationPoint(0.5f, -2.5f, -0.5f);
        ...
        this.gunModel[4].setRotationPoint(0.3f, -2.5f, -0.5f);
        this.gunModel[4].rotateAngleZ = -0.7853982f;
        this.gunModel[5].addBox(0.0f, 0.0f, 0.0f, 1, 1, 0, 0.0f);
        this.gunModel[5].setRotationPoint(0.3f, -3.0f, 0.0f);
        ...
        this.gunModel[12].setRotationPoint(2.0f, -2.2f, -0.6f);
        this.gunModel[12].rotateAngleZ = -0.1919862f;
        ...
        this.ammoModel[0].rotateAngleZ = -0.1919862f;
        (this.slideModel = new ModelRendererTurbo[8])[0] = new ModelRendererTurbo(this, 0, 0, this.textureX,
                this.textureY);
        ...
        this.slideModel[3] = new ModelRendererTurbo(this, 0, 0, this.textureX, this.textureY);
        ...
        this.slideModel[7] = new ModelRendererTurbo(this, 11, 3, this.textureX, this.textureY);
        ...
        this.slideModel[2].addBox(0.0f, 0.0f, 0.0f, 4, 1, 1, 0.0f);
        this.slideModel[2].setRotationPoint(2.0f, -3.0f, -0.4f);
        this.slideModel[3].addBox(0.0f, 0.0f, 0.0f, 1, 1, 1, 0.0f);
        this.slideModel[3].setRotationPoint(0.0f, -3.0f, -0.4f);
        this.slideModel[4].addBox(0.0f, 0.0f, 0.0f, 4, 1, 1, 0.0f);
        this.slideModel[4].setRotationPoint(1.0f, -2.6f, -0.6f);
        this.slideModel[5].addBox(0.0f, 0.0f, 0.0f, 4, 1, 1, 0.0f);
        this.slideModel[5].setRotationPoint(1.0f, -2.6f, -0.4f);
        this.slideModel[6].addBox(0.0f, 0.0f, 0.0f, 1, 1, 1, 0.0f);
        this.slideModel[6].setRotationPoint(0.0f, -3.1f, -0.5f);
        this.slideModel[7].addBox(0.0f, 0.0f, 0.0f, 4, 1, 1, 0.0f);
        this.slideModel[7].setRotationPoint(2.0f, -3.1f, -0.5f);
        this.barrelAttachPoint = new Vector3f(0.375f, 0.15625f, 0.0f);
        this.scopeAttachPoint = new Vector3f(0.03125f, 0.1875f, 0.0f);
