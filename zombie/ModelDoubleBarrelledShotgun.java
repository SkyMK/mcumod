...
public class ModelDoubleBarrelledShotgun extends ModelGun {
    ...
    public ModelDoubleBarrelledShotgun() {
        ...
        super.gunModel[0].addShapeBox(-4.0F, 0.0F, -1.0F, 2, 3, 2, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
        ...
        super.gunModel[1].addShapeBox(-3.0F, 3.0F, -1.0F, 4, 2, 2, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
        ...
        super.gunModel[2].addBox(1.0F, 3.0F, -1.2F, 2.0F, 1.0F, 2.4F);
        super.gunModel[3] = new ModelRendererTurbo(this, 10, 5, textureX, textureY);
        super.gunModel[3].addBox(1.0F, 4.0F, -1.0F, 1, 1, 2);
        ...
        super.ammoModel[0].addBox(1.9F, 4.1F, -0.9F, 3.0F, 0.8F, 0.8F);
        super.ammoModel[1] = new ModelRendererTurbo(this, 20, 0, textureX, textureY);
        super.ammoModel[1].addBox(1.9F, 4.1F, 0.1F, 3.0F, 0.8F, 0.8F);
