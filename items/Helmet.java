...
public class Helmet extends ItemArmor implements IArmorModel {
    @SideOnly(Side.CLIENT)
    public EWjURWOUrw model;
    @SideOnly(Side.CLIENT)
    public ResourceLocation loc;
    public boolean pnv = true;
    public String icon;
    public String texture;

    public Helmet(final int n, final ItemArmor.ArmorMaterial anxb2, final String string, final String string2,
