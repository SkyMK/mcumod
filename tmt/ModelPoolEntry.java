...
public abstract class ModelPoolEntry {
    ...
    protected void applyGroups(Map groupsMap, Map texturesMap) {
        ...
        while (groupsItr.hasNext()) {
            ...
            for (currentGroup = this.name + "_" + nameIdx + ":" + groupKey; groupsMap.size() > 0
                    && groupsMap.containsKey(currentGroup); currentGroup = this.name + "_" + nameIdx + ":" + groupKey) {
                ++nameIdx;
            }
        ...
        while (texturesItr.hasNext()) {
            ...
            for (currentGroup = this.name + "_" + nameIdx + ":" + groupKey; groupsMap.size() > 0 && texturesMap
                    .containsKey(currentGroup); currentGroup = this.name + "_" + nameIdx + ":" + groupKey) {
                ++nameIdx;
            }
