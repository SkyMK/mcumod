                        ...
                        if (s.startsWith("v ")) {
                            ...
                            for (var23 = 0; var23 < 3; ++var23) {
                                ...
                                if (finalPhase > -1) {
                                    ...
                                    var21[var23] = Float.parseFloat(s);
                                }
                            ...
                            do {
                                ...
                                iNormal.add(
                                        Vec3.createVectorHelper(poly[0], poly[1], poly[2]));
                                normal[0] += poly[0];
                                normal[1] += poly[1];
                                normal[2] += poly[2];
                                if (d < verts.size()) {
                                    i.add(((PositionTransformVertex) verts.get(d)).setTexturePosition(vToArr[0],
                                            vToArr[1]));
                            ...
                            float var25 = MathHelper.sqrt_double(
